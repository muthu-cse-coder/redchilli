            ...
            <div className={styles.container}>
                ...
                <div className={styles.bottomBar}>
                    ...
                    <div className={styles.socialIcons}>
                        <a
                            href="https://www.facebook.com/61560480880646"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg viewBox="0 0 24 24">
                                <path d="M22 12a10 10 0 1 0-11.5 9.9v-7H8v-3h2.5V9.5A3.5 3.5 0 0 1 14 6h2.5v3H14a1 1 0 0 0-1 1V12h3l-.5 3H13v7A10 10 0 0 0 22 12z" />
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/redchilli2026"
                            target="_blank"
                            rel="noopener noreferrer">
                        ...
                        <a
                            href="https://www.youtube.com/@Mychannelname"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg viewBox="0 0 24 24">
                                <path d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2 31.4 31.4 0 0 0 0 12a31.4 31.4 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1A31.4 31.4 0 0 0 24 12a31.4 31.4 0 0 0-.5-5.8zM9.6 15.5v-7L16 12l-6.4 3.5z" />
                            </svg>
                        </a>
                    </div>
                </div>
