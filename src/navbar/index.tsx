...
// }
//     return (
//         <nav className={`${style.stNavBarWrapper} ${scrolled ? style.scrolled : ""}`} id="form">
//             {/* Logo Section */}
...
//                 <button type="button" className={style.stPurchaseButton} onClick={hanldlenavigate}>BOOK VEHICLE</button>
